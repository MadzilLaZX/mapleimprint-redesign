...
const SOURCE_LICENSE_URL: Record<(typeof OPEN_ICONS)[number]["source"], string> = {
  tabler: "https://github.com/tabler/tabler-icons/blob/main/LICENSE",
  heroicons: "https://github.com/tailwindlabs/heroicons/blob/master/LICENSE",
  bootstrap: "https://github.com/twbs/icons/blob/main/LICENSE",
};
const SOURCE_URL: Record<(typeof OPEN_ICONS)[number]["source"], string> = {
...
export const OPEN_ICON_ASSETS: DesignAsset[] = OPEN_ICONS.map((icon) => ({
  ...
  licenseType: "MIT",
  licenseUrl: SOURCE_LICENSE_URL[icon.source],
  sourceUrl: SOURCE_URL[icon.source],
