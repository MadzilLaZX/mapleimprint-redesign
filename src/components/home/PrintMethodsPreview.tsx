...
import { ArrowRight, Drop, Needle, Palette, Printer, StackSimple } from "@phosphor-icons/react/dist/ssr";
  ...
  return (
    <section className="bg-white py-20 md:py-28 lg:py-32">
      <Container>
        ...
        <RevealGroup className="mt-12 grid gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-5">
